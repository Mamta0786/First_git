  ...
  return (
    <>
      <div className="container mt-4">
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            style={{color : props.mode1=== 'dark'?'white':'black',backgroundColor : props.mode1=== 'dark'?'#0b0632':'white'}}
            id="text"
            rows="8"
            value={text}
            onChange={textHandle}
      ...
      <div className="container">
        <button className="btn btn-primary mx-1" onClick={convertUpCase}>
          Convert into UpperCase
        </button>
        <button className="btn btn-primary mx-1" onClick={convertLoCase}>
          Convert into LowerCase
        </button>
      </div>
      <div className="container my-3">
        <p>
          {wordCount(text)} word and {text.length}{" "}
          character.
        </p>
        <h2>Preview</h2>
        <p>
